...
grouped together:
  ...
  Stage A — transcripts   (Telegram-A27-Download/, canonically named)
...
TRANSCRIPT_SRC = Path("/mnt/g/My Drive/000-Education/00-Avyaan/Telegram-A27-Download")
COLLECTED_SRC  = Path("/mnt/g/My Drive/000-Education/00-Avyaan/Bakliwal-Study-9th-26-27/Collected-Study-Materials")
TARGET_ROOT    = Path("/mnt/g/My Drive/000-Education/00-Avyaan/Bakliwal-Study-9th-26-27/AI-Chapter-Notes")
CLASSIFY_DIR   = Path("/mnt/g/My Drive/000-Education/00-Avyaan/Telegram-A27-Download/scripts")
